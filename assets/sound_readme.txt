...
- Type: Simple beep or click sound
- Volume: Moderate (will be adjustable in code)

You can:
1. Record a simple "beep" sound using QuickTime Player or Audacity
2. Download a free sound effect from freesound.org
